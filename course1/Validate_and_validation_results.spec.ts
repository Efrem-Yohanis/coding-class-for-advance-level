...
test.describe('Validation Results & Download PDF – 13F Deal', () => {
  ...
  test('TC-413517: Validation Results and Download PDF buttons are enabled', async () => {
    ...
    /**
     * Step 5: Wait for validation completion
     */
    await expect(
    ...
    /**
     * Step 8: Validation Results button enabled & PDF generated
     */
    ...
    /**
     * Step 9: Number of Errors is displayed
     */
    ...
    /**
     * Step 10: Number of Warnings is displayed
     */
    ...
    /**
     * Step 8 (continued): Download PDF enabled & works
     */
